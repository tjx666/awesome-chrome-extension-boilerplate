// generated by curl http://localhost:8097 > server/utils/react-devtools.js
...
// EXTERNAL MODULE: /Users/skyyao/local/react/build/oss-experimental/react-debug-tools/index.js
...
function P(a, b, d) {
  var c,
      ...
      l = null,
      h = null;
  if (null != b) for (c in void 0 !== b.ref && (h = b.ref), void 0 !== b.key && (l = "" + b.key), b) {
    M.call(b, c) && !O.hasOwnProperty(c) && (e[c] = b[c]);
  }
...
function T(a, b, d, c, e) {
  ...
  if (h) return h = a, e = e(h), a = "" === c ? "." + S(h, 0) : c, L(e) ? (d = "", null != a && (d = a.replace(R, "$&/") + "/"), T(e, b, d, "", function (a) {
    return a;
  })) : null != e && (Q(e) && (e = da(e, d + (!e.key || h && h.key === e.key ? "" : ("" + e.key).replace(R, "$&/") + "/") + a)), b.push(e)), 1;
  h = 0;
  c = "" === c ? "." : c + ":";
  if (L(a)) for (var g = 0; g < a.length; g++) {
    l = a[g];
    var f = c + S(l, g);
    h += T(l, b, d, f, e);
  } else if (f = ca(a), "function" === typeof f) for (a = f.call(a), g = 0; !(l = a.next()).done;) {
    l = l.value, f = c + S(l, g++), h += T(l, b, d, f, e);
...
exports.cloneElement = function (a, b, d) {
  ...
  if (null != b) {
    void 0 !== b.ref && (l = b.ref, h = N.current);
    void 0 !== b.key && (e = "" + b.key);
    if (a.type && a.type.defaultProps) var g = a.type.defaultProps;

    for (f in b) {
      M.call(b, f) && !O.hasOwnProperty(f) && (c[f] = void 0 === b[f] && void 0 !== g ? g[f] : b[f]);
    }
  }
...
exports.createServerContext = function (a, b) {
  ...
  c = Z[a];
  if (c._defaultValue === C) c._defaultValue = b, c._currentValue === C && (c._currentValue = b), c._currentValue2 === C && (c._currentValue2 = b);else if (d) throw Error("ServerContext: " + a + " already defined");
  return c;
};

exports.experimental_use = function (a) {
  return V.current.use(a);
};

exports.experimental_useEvent = function (a) {
  return V.current.useEvent(a);
};
...
exports.unstable_useMemoCache = function (a) {
  return V.current.useMemoCache(a);
};

exports.useCallback = function (a, b) {
  return V.current.useCallback(a, b);
};
...
exports.useEffect = function (a, b) {
  return V.current.useEffect(a, b);
};
...
exports.useImperativeHandle = function (a, b, d) {
  return V.current.useImperativeHandle(a, b, d);
};

exports.useInsertionEffect = function (a, b) {
  return V.current.useInsertionEffect(a, b);
};

exports.useLayoutEffect = function (a, b) {
  return V.current.useLayoutEffect(a, b);
};

exports.useMemo = function (a, b) {
  return V.current.useMemo(a, b);
};

exports.useReducer = function (a, b, d) {
  return V.current.useReducer(a, b, d);
};
...
exports.useSyncExternalStore = function (a, b, d) {
  return V.current.useSyncExternalStore(a, b, d);
};
...
exports.version = "18.3.0-experimental-44e2ca393-20221014";
...
// EXTERNAL MODULE: /Users/skyyao/local/react/node_modules/lodash.throttle/index.js
...
// CONCATENATED MODULE: /Users/skyyao/local/react/node_modules/memoize-one/esm/index.js
